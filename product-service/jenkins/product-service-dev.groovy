      ...
      steps {
        script {
          ...
          if (!(branch == 'develop' || branch.startsWith('feat/'))) {
            error "product-service-dev solo se ejecuta en ramas develop o feat/** (rama actual: '${branch}')."
          }
        ...
        if (env.GIT_BRANCH) {
          try {
            step([$class: 'GitHubCommitStatusSetter',
              ...
              contextSource: [$class: 'ManuallyEnteredCommitContextSource', context: 'ci/jenkins/product-service'],
